...
VL_ATTR_COLD void Vjk_tb___024root__trace_full_0_sub_0(Vjk_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelf->jk_tb__DOT__j));
    bufp->fullBit(oldp+2,(vlSelf->jk_tb__DOT__k));
    bufp->fullBit(oldp+3,(vlSelf->jk_tb__DOT__clk));
    bufp->fullBit(oldp+4,(vlSelf->jk_tb__DOT__rst));
    bufp->fullBit(oldp+5,(vlSelf->jk_tb__DOT__q));
    bufp->fullBit(oldp+6,((1U & (~ (IData)(vlSelf->jk_tb__DOT__q)))));
}
