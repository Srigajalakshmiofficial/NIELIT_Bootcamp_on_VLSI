...
void Vjk_tb___024root__trace_chg_0_sub_0(Vjk_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgBit(oldp+0,(vlSelf->jk_tb__DOT__j));
    bufp->chgBit(oldp+1,(vlSelf->jk_tb__DOT__k));
    bufp->chgBit(oldp+2,(vlSelf->jk_tb__DOT__clk));
    bufp->chgBit(oldp+3,(vlSelf->jk_tb__DOT__rst));
    bufp->chgBit(oldp+4,(vlSelf->jk_tb__DOT__q));
    bufp->chgBit(oldp+5,((1U & (~ (IData)(vlSelf->jk_tb__DOT__q)))));
}
